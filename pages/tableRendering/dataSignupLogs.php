...
$query = 'SELECT l.id, l.dataLogs, l.dataStripe, l.stripeResult, l.dataContract, l.dataContractPushpos, l.countryCode, l.createAt, s.status FROM logssignup l, logsstatus s WHERE l.status = s.id';
