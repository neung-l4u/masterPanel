...
foreach ($result as $row) {
    ...
    $contractLogsBtn = empty($contractURL) ? "-" : '<a href="'.htmlspecialchars($contractURL, ENT_QUOTES).'" target="_blank" title="Marketing Agreement">'.$contractIconSvg.'</a>';
    $contractPushposLogsBtn = empty($contractPushposURL) ? "-" : '<a href="'.htmlspecialchars($contractPushposURL, ENT_QUOTES).'" target="_blank" title="Push POS Agreement" class="text-primary">'.$contractIconSvg.'</a>';
