...
foreach ($result as $row) {
    ...
    if($row["county"] == "AU"){
        $row["county"] = "Austalia";
    }else if($row["county"] == "NZ"){
        $row["county"] = "New Zealand";
    }else if($row["county"] == "US"){
        $row["county"] = "United States";
    }else if($row["county"] == "CA"){
        $row["county"] = "Canada";
    }else if($row["county"] == "UK"){
        $row["county"] = "United Kingdom";
    }else if($row["county"] == "TH"){
        $row["county"] = "Thailand";
    }
