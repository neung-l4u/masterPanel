...
const KEY_LABEL = {
  ...
  down:         ['เว็บล่ม — เซิร์ฟเวอร์ตอบ error','DNS ปกติ แต่เซิร์ฟเวอร์ตอบ 403 / 404 / 500'],
  dns_fail:     ['DNS หาไม่เจอชั่วคราว',      'โดเมนยังจดอยู่ แต่ resolve ไม่ได้ — มักเป็นแค่ชั่วคราว'],
  timeout:      ['ตอบช้าเกิน 30 วินาที',     'เซิร์ฟเวอร์ยังอยู่แต่ช้ามาก'],
  conn_refused: ['ต่อเซิร์ฟเวอร์ไม่ได้',       'DNS ปกติ แต่ไม่มีอะไรรับการเชื่อมต่อ'],
  ssl_error:    ['SSL มีปัญหา',              'ใบรับรองผิดพลาดจนเชื่อมต่อไม่ได้'],
