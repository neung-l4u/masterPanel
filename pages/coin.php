                        ...
                        <div class="card-body">
                            <div class="row">
                                ...
                                <div class="col-6">
                                    <div class="form-group row">
                                        ...
                                        <input id="coinAmount" type="number" step="1" class="form-control col" value="1"
                                               placeholder="20">
                                    </div>
                                </div>
                                <div class="col"></div>
                            ...
                            <div class="row">
                                ...
                                <div class="form-group col-10">
                                    ...
                                    <small id="CoinActivitiesHelp" class="form-text text-muted">If you need additional types, please tell Nueng.</small>
                                </div>
                                <div class="col"></div>
                            </div>
