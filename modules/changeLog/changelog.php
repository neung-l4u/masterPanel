...
<div class="container">
    <div class="sidebar">
        <div class="logo-container">
            <img src="assets/img/img.png" alt="Logo Localforyou">
        </div>
        <h2>Change Log</h2>
        <ul>
            <li data-page="signup" class="active">Signup Form <span style="color: #dd0000;">NEW!</span></li>
            <li data-page="website">Website Submission <span style="color: #dd0000;">NEW!</span></li>
            ...
            <li data-page="feedback" >Feedback</li>
