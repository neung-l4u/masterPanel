...
$shopName = "Kin Jung Thai Restaurant";
$tradingName = "KJ Group Co. Ltd.";
$address = "1/10 Memorial AvenueTewantin Queensland 4565 Australia";
$fullName = "Pannarai Prawatpong";
$mobile = "+61 423 937 294";
$email = "fern23_ubon@hotmail.com";
$lastDate = "15 December 2023";
$reason = "Renovate Shop";
$comment = "Would be back on June 2024";
?>
<!DOCTYPE html>
<html lang="en">
<head>
    ...
    <![endif]-->
<!--    <link rel="stylesheet" href="https://signup.localforyou.com/assets/css/email_cancellation.css">-->
                                            ...
                                            <td class="pad">
                                                <div style="font-family: sans-serif">
                                                    <div class="" style="font-size: 14px; font-family: Helvetica Neue, Helvetica, Arial, sans-serif; mso-line-height-alt: 16.8px; color: #506bec; line-height: 1.2;">
                                                        <p style="margin: 0; font-size: 14px; mso-line-height-alt: 16.8px;"><strong><span style="font-size:38px;"><span style="font-size:20px;">Thai Cottage - USA</span></span></strong></p>
                                                    </div>
                                                </div>
                                            </td>
                                        </tr>
                                            ...
                                            <td class="pad">
                                                <div style="font-family: sans-serif">
                                                    <div class="" style="font-size: 14px; font-family: Helvetica Neue, Helvetica, Arial, sans-serif; mso-line-height-alt: 16.8px; color: #40507a; line-height: 1.2;">
                                                        <p style="margin: 0; font-size: 14px; mso-line-height-alt: 16.8px;"><span style="font-size:16px;">Hey, we received a cancellation request from AU customer.</span></p>
                                                    </div>
                                                </div>
                                            </td>
                                        </tr>
                                    ...
                                    <table border="0" cellpadding="10" cellspacing="0" class="text_block block-3" role="presentation" style="mso-table-lspace: 0pt; mso-table-rspace: 0pt; word-break: break-word;" width="100%">
                                        <tr>
                                            <td class="pad">
                                                <div style="font-family: sans-serif">
                                                    <div class="" style="font-size: 14px; font-family: Helvetica Neue, Helvetica, Arial, sans-serif; mso-line-height-alt: 16.8px; color: #40507a; line-height: 1.2;">
                                                        <p style="margin: 0; font-size: 14px; mso-line-height-alt: 16.8px;"><span style="font-size:16px;">as detailed below</span></p>
                                                    </div>
                                                </div>
                                            </td>
                                        </tr>
                                        ...
                                        <tr>
                                            <td class="pad">
                                                <div style="color:#000000;font-size:14px;font-family:Helvetica Neue, Helvetica, Arial, sans-serif;font-weight:400;line-height:120%;text-align:left;direction:ltr;letter-spacing:0px;mso-line-height-alt:16.8px;">
                                                    <p style="margin: 0; margin-bottom: 16px;"><strong>Country :</strong> <?php echo $countryText; ?><br>
                                                        <strong>Shop name :</strong> <?php echo $shopName; ?><br>
                                                        <strong>Trading name :</strong> <?php echo $tradingName; ?><br>
                                                        <strong>Address :</strong><br>
                                                        <?php echo $address; ?>
                                                    </p>
                                                    <p style="margin: 0; margin-bottom: 16px;"><strong>Full name :</strong> <?php echo $fullName; ?><br>
                                                        <strong>Mobile :</strong> <?php echo $mobile; ?><br>
                                                        <strong>Email :</strong> <a href="$email" style="text-decoration: underline; color: #0068a5;"><?php echo $email; ?></a>
                                                    </p>
                                                    <p style="margin: 0; margin-bottom: 16px;"><strong>Last date : <?php echo $lastDate; ?><br>
                                                            Reason :</strong> <?php echo $reason; ?>
                                                    </p>
                                                    <p style="margin: 0;"><strong>Comment :</strong><br>
                                                        <?php echo $comment; ?>
                                                    </p>
                                                </div>
                                            </td>
                                    ...
                                    <table border="0" cellpadding="10" cellspacing="0" class="text_block block-8" role="presentation" style="mso-table-lspace: 0pt; mso-table-rspace: 0pt; word-break: break-word;" width="100%">
                                        <tr>
                                            <td class="pad">
                                                <div style="font-family: sans-serif">
                                                    <div class="" style="font-size: 14px; font-family: Helvetica Neue, Helvetica, Arial, sans-serif; mso-line-height-alt: 16.8px; color: #40507a; line-height: 1.2;">
                                                        <p style="margin: 0; font-size: 14px; mso-line-height-alt: 16.8px;"><span style="font-size:14px;">Having trouble? <a href="mailto:neung@localforyou.com?subject=Problem%20:%20Cancellation%20email" rel="noopener" style="text-decoration: underline; color: #40507a;" target="_blank" title="neung@localforyou.com">neung@localforyou.com</a></span></p>
                                                    </div>
                                                </div>
                                            </td>
                                        </tr>
                            ...
                            <tr>
                                <td class="column column-1" style="mso-table-lspace: 0pt; mso-table-rspace: 0pt; font-weight: 400; text-align: left; padding-bottom: 5px; vertical-align: top; border-top: 0px; border-right: 0px; border-bottom: 0px; border-left: 0px;" width="100%">
                                    <table border="0" cellpadding="0" cellspacing="0" class="image_block block-1" role="presentation" style="mso-table-lspace: 0pt; mso-table-rspace: 0pt;" width="100%">
                                        <tr>
                                            <td class="pad" style="width:100%;padding-right:0px;padding-left:0px;">
                                                <div align="center" class="alignment" style="line-height:10px"><img alt="Card Bottom with Border and Shadow Image" class="big" src="https://signup.localforyou.com/assets/img/bottom_img.png" style="display: block; height: auto; border: 0; width: 600px; max-width: 100%;" title="Card Bottom with Border and Shadow Image" width="600"></div>
                                            </td>
                                        </tr>
                                    </table>
                                </td>
                                        ...
                                        <tr>
                                            <td class="pad" style="width:100%;padding-right:0px;padding-left:0px;">
                                                <div align="center" class="alignment" style="line-height:10px">
                                                    <a href="http://www.example.com/" style="outline:none" tabindex="-1" target="_blank"><img alt="Your Logo" src="https://signup.localforyou.com/assets/img/newL4U-logo-100x100.png" style="display: block; height: auto; border: 0; width: 100px; max-width: 100%;" title="Your Logo" width="100"></a>
                                                </div>
                                            </td>
                                        </tr>
                                    </table>
                                            ...
                                            <td class="pad">
                                                <div style="font-family: sans-serif">
                                                    <div class="" style="font-size: 14px; font-family: Helvetica Neue, Helvetica, Arial, sans-serif; mso-line-height-alt: 16.8px; color: #97a2da; line-height: 1.2;">
                                                        <p style="margin: 0; text-align: center; font-size: 12px; mso-line-height-alt: 14.399999999999999px;"><span style="font-size:12px;">Copyright© 2021 Local For You.</span></p>
                                                    </div>
                                                </div>
                                            </td>
                                        </tr>
