            ...
            <div class="card">
                ...
                <div class="card-body p-4">
                    ...
                    <div class="row">
                        <div class="col">
                            <div class="form-group">
                                <label for="company" class="font-weight-bold">Trading name</label>
...
<script src="https://report.localforyou.com/modules/signupMini/assets/js/index.js?v=2.0.1"></script>
<script>
