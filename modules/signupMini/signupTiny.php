...
<script>
    ...
    $("#tinyForm1").submit(function (e) {
        ...
        const payload = {
            ...
            countryCode: "",
            shopType: form.find("#shopType").val(),
            formType: form.find("#formType").val(),
            leadSource: form.find("#leadSource").val(),
            leadRecordType: form.find("#leadRecordType").val()
        };
        ...
        <div class="col-md-12">
             <!-- <div class="card bg-light mb-3 mt-3 shadow-lg">"card" class in replacement with "fieldset" -->
                ...
                <div class="card-body">
                    ...
                    <!--<div class="card-header"></div>-->
                    <form action="#" method="POST" id="tinyForm2">
                        <input type=hidden name="oid" value="oid">
                        <input type=hidden name="retURL" value="https://localforyou.com/thank-you/">
