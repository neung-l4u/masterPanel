...
<!-- Modal Response-->
<div class="modal fade" id="modalResponse" data-bs-backdrop="static" data-bs-keyboard="false" tabindex="-1"
     aria-labelledby="modalRespondLabel" aria-hidden="true">
          ...
          <div class="modal-content">
               <div class="respondSuccess">
                    ...
                    <div class="modal-body text-center">
                         ...
                         <p>The receipt file has been sent to <span class="receiveEmail fw-bold text-info"> your
                                   registered email address</span>. <br>
                         ...
                         <div id="thPaymentSection" style="display:none; text-align:left;" class="mb-3">
                              <!-- Bank info card -->
                              <div
                                   style="border:1px solid #e0e0e0; border-radius:12px; overflow:hidden; margin-bottom:16px;">
                                   <div class="d-flex" style="min-height:160px;">
                                        ...
                                        <div style="flex:1; padding:16px; border-right:1px solid #e0e0e0;">
                                             ...
                                             <div class="mb-1">
                                                  ...
                                                  <strong
                                                       style="font-size:14px;">สาขาสำนักแจ้งวัฒนะเมืองทองธานี</strong>
                                             </div>
                                             <div class="mb-3">
                                                  <span style="font-size:11px; color:#888;">หมายเลขบัญชี</span><br>
                                                  <strong style="font-size:15px;"
                                                       id="thAccountNumber">056-1-85639-7</strong>
                                             </div>
                                        ...
                                        <div style="flex:1; padding:16px;">
                                             ...
                                             <ol style="list-style:none; font-size:13px; margin-top:10px; padding-left:0; line-height:1.8;"
                                                  id="thHowToList">
                                                  <li class="d-flex align-items-start gap-2 mb-2">
                                                       <span>คัดลอกหมายเลขบัญชีโดยกดปุ่ม 'คัดลอก'</span></li>
                                                  <li class="d-flex align-items-start gap-2 mb-2"><span>ไปที่
                                                            'โอนเงิน'</span></li>
                                                  <li class="d-flex align-items-start gap-2 mb-2">
                                                       <span>เลือกรายการโอนเป็น 'บัญชีกสิกรไทย'</span></li>
                                                  <li class="d-flex align-items-start gap-2 mb-2"><span>นำเลขบัญชีวางตรง
                                                            'ระบุเลขบัญชี' และกรอกตัวเลขในช่อง 'จำนวน'</span></li>
                                             </ol>
                                        </div>
                                   </div>
                              </div>
                              <!-- Payment expiry countdown -->
                              <div id="thCountdownBox" class="mb-3"
                                   style="display:none; border:1px solid #bee5eb; background:#e8f4f8; border-radius:8px; padding:10px 14px;">
                                   <div class="d-flex align-items-center justify-content-between">
                                        <span style="font-size:13px; color:#0c5460;">
                                             <i class="bi bi-clock-history mr-1"></i>
                                             รายการชำระเงินจะหมดอายุในอีก
                                        </span>
                                        <span id="thCountdownTimer"
                                             style="font-family:'Courier New',monospace; font-size:16px; font-weight:700; color:#0c5460;">10:00</span>
                                   </div>
                              </div>
                              ...
                              <div class="mb-3">
                                   <label id="thSlipLabel" for="thSlipUpload"
                                        ...
                                        onmouseover="this.style.borderColor='#888'"
                                        onmouseout="if(!document.getElementById('thSlipUpload').files[0])this.style.borderColor='#d0d0d0'">
                                        <span id="thSlipIcon" class="d-block mb-2" style="line-height:1;">
                                             <svg xmlns="http://www.w3.org/2000/svg" width="30" height="30" fill="#aaa"
                                                  viewBox="0 0 16 16">
                                                  <path
                                   ...
                                   <input type="file" class="d-none" id="thSlipUpload" accept="image/*" onchange="
                              ...
                              <button type="button" id="thFinishButton" disabled class="btn btn-success w-100"
                         ...
                         <div class="pt-2" id="crmControls">
                              <div class="form-switch">
                                   <input class="form-check-input" type="checkbox" role="switch" id="enableCRM"
                                        onclick="enableCRMButton();">
                                   <label class="form-check-label text-danger" for="enableCRM">Save to Monday</label>
                              </div>
                              <img src="assets/img/ballLoading.gif" alt="loading" id="ballLoading" width="30"
                                   height="30" style="display:none;">
                              <span id="countdownText" class="text-muted fw-bold"
                                   style="display:none; margin-left: 10px;"></span>
                              <button type="button" id="CRMButton" disabled class="btn btn-primary"
                                   style="display:none;" onclick="submitToCRM();">Save</button>
                         </div>
                    </div>
               </div>
               ...
               <div class="respondFail">
                    ...
                    <div class="modal-body text-center">
                         ...
                         <div id="failReasonBox" class="alert alert-warning text-start small mx-auto"
                         ...
                         <p>Please check your payment information <br> and wait 5 seconds and try submit again. <br><br>
                              If it still can't be done please contact <a
                                   href="mailto:admin@localforyou.com">admin@localforyou.com</a> </p>
...
function sendThTransferProof() {
     ...
     if (!quotationID) {
          try {
               ...
               console.warn('sendThTransferProof dataInvoice parse error:', e);
          }
     }
     ...
     $.ajax({
          ...
          success: function(res) {
               if (res.success) {
                    sendBtn.text('ส่งสำเร็จ ✓').removeClass('btn-primary').css({
                         'background': '#198754',
                         'color': '#fff'
                    });
                    $("#thSlipFileName").text(slipInput.files[0].name + ' (อัปโหลดพร้อมแล้ว)').css(
                         'color', '#0d6efd');
