...
// test data
 $param = array(
     ...
     "MainProduct" => "Pro Online Ordering System - $49.00 /Month",
     "formSalesAgent" => "Other",
     "formContractPeriod" => "No contract",
     "formRefPerson" => "-",
     "formRefPartner" => "-",
     "formCoupon" => "-",
     "formRefShop" => "-",
     "formFirstTimePayment" => "49 USD",
     ...
     "formShopName" => "Asian Vegan Bistro",
     "formCountry" => "United states",
     "formState" => "CA : California",
     "formFullName" => "Wiengping Sarasom",
     "formEmail" => "sandybenjaporn@yahoo.com",
     "formMobile" => "+16615649005",
     "formBestTime" => "9am - 10 am and 1 pm onwards california time",
     "acceptAutoPilotAI" => true,
     "formNote" => "-",
     "formstartProjectAs" => "-",
    "formstartProjectOther" => "2025-03-04",
    "formstartprojectNote" => "-",
     "mode" => "alert",
     "token" => "6.552534",
     "formInitialProductOffering" => "Pro Online Ordering System - $49.00 /Month",
     "testMail" => "0"
 );
