...
// test data
 $param = array(
     ...
     "MainProduct" => "Social Media Marketing Solo - $199.00 /Month",
     "formSalesAgent" => "Nan Chompunuch",
     "formContractPeriod" => "12 months",
     "formRefPerson" => "Mungdee",
     "formRefPartner" => "-",
     "formCoupon" => "-",
     "formRefShop" => "Thai Spice",
     "formFirstTimePayment" => "199 USD",
     ...
     "formShopName" => "Sawasdee Thai Cuisine",
     "formCountry" => "United States",
     "formAddress" => "1950 Hendersonville Rd #5 ,Asheville ,NC : North Carolina ,28803 ,United States",
     "formFullName" => "Mungdee Phromputi",
     "formEmail" => "sawasdeekruathaillc@gmail.com",
     "formMobile" => "+19194806113",
     "formBestTime" => "3 pm everyday",
     ...
     "mode" => "alert",
     "token" => "6.552534",
     "formInitialProductOffering" => "Social Media Marketing Solo - $199.00 /Month",
     "testMail" => "0"
 );
