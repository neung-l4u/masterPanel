...
// test data
 $param = array(
     ...
     "MainProduct" => "Promotion - Direct Marketing Solo - £109.00 /Month",
     ...
     "formCoupon" => "-",
     "formRefShop" => "-",
     "formFirstTimePayment" => "109.00 GBP",
    ...
    "formstartprojectNote" => "-",
     "mode" => "alert",
     "token" => "6.552534",
     "formInitialProductOffering" => "Promotion - Direct Marketing Solo - £109.00 /Month",
     "testMail" => "0"
 );
