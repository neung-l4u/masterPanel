<?php
$data['countryText'] = "Australia";
$data['shopName'] = "Kin Jung Thai Restaurant";
$data['tradingName'] = "KJ Group Co. Ltd.";
$data['address'] = "1/10 Memorial AvenueTewantin Queensland 4565 Australia";
$data['fullName'] = "Pannarai Prawatpong";
$data['mobile'] = "+61 423 937 294";
$data['email'] = "fern23_ubon@hotmail.com";
$data['lastDate'] = "15 December 2023";
$data['reason'] = "Renovate Shop";
$data['comment'] = "Would be back on June 2024";
...
<head>
    ...
    <![endif]-->
    <link rel="stylesheet" href="../assets/css/email_cancellation.css">
</head>
...
<table border="0" cellpadding="0" cellspacing="0" class="nl-container" role="presentation" style="mso-table-lspace: 0pt; mso-table-rspace: 0pt; background-color: #d9dffa;" width="100%">
    ...
    <tr>
        <td>
            ...
            <table align="center" border="0" cellpadding="0" cellspacing="0" class="row row-2 tbl1" role="presentation" style="mso-table-lspace: 0pt; mso-table-rspace: 0pt;" width="100%">
                <tbody>
                <tr>
                    <td>
                        <table align="center" border="0" cellpadding="0" cellspacing="0" class="row-content stack" role="presentation" style="mso-table-lspace: 0pt; mso-table-rspace: 0pt; color: #000000; width: 600px;" width="600">
                            ...
                            <tr>
                                <td class="column column-1" style="mso-table-lspace: 0pt; mso-table-rspace: 0pt; font-weight: 400; text-align: left; padding-bottom: 15px; padding-left: 50px; padding-right: 50px; padding-top: 15px; vertical-align: top; border-top: 0px; border-right: 0px; border-bottom: 0px; border-left: 0px;" width="100%">
                                    <table border="0" cellpadding="10" cellspacing="0" class="text_block block-1" role="presentation" style="mso-table-lspace: 0pt; mso-table-rspace: 0pt; word-break: break-word;" width="100%">
                                        <tr>
                                          ...
                                          <span style="font-size:38px;">
                                            <span style="font-size:20px;"> <?php echo $data['shopName']; ?> </span>
                                          </span>
                                                            </strong>
                                                        </p>
                                                    </div>
                                                ...
                                                <div style="font-family: sans-serif">
                                                    <div class="" style="font-size: 14px; font-family: Helvetica Neue, Helvetica, Arial, sans-serif; mso-line-height-alt: 16.8px; color: #40507a; line-height: 1.2;">
                                                        <p style="margin: 0; font-size: 14px; mso-line-height-alt: 16.8px;">
                                                            ...
                                                            Confirmation of Your Registration with Local For You
                                                        </p>
                                                    </div>
                                                </div>
                                                <div style="font-family: sans-serif;">
                                                    <p style="font-family: Helvetica Neue, Helvetica, Arial, sans-serif; mso-line-height-alt: 16.8px; font-weight: bold; color: #506bec;">
                                        ...
                                        <tr>
                                            <td class="pad">
                                                <div style="font-family: sans-serif">
                                                    <div class="" style="font-size: 14px; font-family: Helvetica Neue, Helvetica, Arial, sans-serif; mso-line-height-alt: 16.8px; color: #40507a; line-height: 1.2;">
                                                        <p style="margin: 0;">
                                                            We extend our warm congratulations on your recent sign-up <br />
                                                            with Local For You
                                                        </p>
                                                    </div>
                                                    <div class="" style="font-size: 14px; font-family: Helvetica Neue, Helvetica, Arial, sans-serif; mso-line-height-alt: 16.8px; color: #40507a; line-height: 1.2; margin-top:20px;">
                                                        <p style="margin: 0; line-height:130%;">
                                                            Our team is dedicated to providing top-notch service to ensure your online presence is established promptly and efficiently.
                                                            However, to expedite this process, we kindly request your cooperation in furnishing us with the necessary information to develop your website.
                                                        </p>
                                                        <p style="margin-top:20px;"><strong>The details we require are outlined below:</strong></p>
                                                    </div>
                                                </div>
                                            </td>
                                        </tr>
                                    ...
                                    <table border="0" cellpadding="10" cellspacing="0" class="paragraph_block block-5" role="presentation" style="mso-table-lspace: 0pt; mso-table-rspace: 0pt; word-break: break-word;" width="100%">
                                        <tr>
                                            <td class="pad">
                                                <div style="color:#000000;font-size:14px;font-family:Helvetica Neue, Helvetica, Arial, sans-serif;font-weight:400;line-height:120%;text-align:left;direction:ltr;letter-spacing:0px;mso-line-height-alt:16.8px;">
                                                    <ol style="line-height:180%">
                                                        <li>Verify domain name by click “ My account ” on email subject {domain name}  is pending approval</li>
                                                        <li>Menu, LOGO, Food picture and shop’s picture</li>
                                                        <li>Google my business access</li>
                                                        <li>Facebook page access</li>
                                                        <li>Online Payment Platform Registration: Our customer support team will assist you in registering on the online payment platform. Kindly expect further guidance through a registration link.</li>
                                                    </ol>
                                                </div>
                                            </td>
                                        </tr>
                                    ...
                                    <table border="0" cellpadding="10" cellspacing="0" class="text_block block-8" role="presentation" style="mso-table-lspace: 0pt; mso-table-rspace: 0pt; word-break: break-word;" width="100%">
                                        <tr>
                                            <td class="pad">
                                                <div style="font-family: sans-serif">
                                                    <div class="" style="font-size: 14px; font-family: Helvetica Neue, Helvetica, Arial, sans-serif; mso-line-height-alt: 16.8px; color: #40507a; line-height: 1.2;">
                                                        <p>We are committed to working closely with you to maximise the benefits for your business in the shortest possible time frame.</p>
                                                        <p>Thank you for choosing Local For You. We eagerly anticipate a fruitful partnership and remain at your service for any assistance you may require.</p>
                                                        <p style="margin-top: 30px;"><strong>Warm regards,</strong></p>
                                                        <p><strong>Customer Support Team</strong></p>
                                                        <p style="margin: 0; font-size: 10px; mso-line-height-alt: 16.8px; text-align: right;">
                                                            Having trouble?
                                                            <a href="mailto:<?php echo $data['adminEmail']; ?>?subject=Problem%20:%20Confirmation%20email" rel="noopener" style="text-decoration: underline; color: #40507a;" target="_blank" title="<?php echo $data['adminEmail']; ?>"><?php echo $data['adminEmail']; ?></a>
                                                        </p>
                                                    </div>
                                                </div>
                                            </td>
                                        ...
                                        <tr>
                                            <td class="pad" style="width:100%;padding-right:0px;padding-left:0px;">
                                                <div align="center" class="alignment" style="line-height:10px">
                                                    <img alt="Card Bottom with Border and Shadow Image" class="big" src="https://signup.localforyou.com/assets/img/bottom_img.png" style="display: block; height: auto; border: 0; width: 600px; max-width: 100%;" title="Card Bottom with Border and Shadow Image" width="600">
                                                </div>
                                            </td>
                                        </tr>
                                    </table>
                ...
                <tr>
                    <td>
                        <table align="center" border="0" cellpadding="0" cellspacing="0" class="row-content stack" role="presentation" style="mso-table-lspace: 0pt; mso-table-rspace: 0pt; color: #000000; width: 600px;" width="600">
                            <tbody>
                            <tr>
                                <td class="column column-1" style="mso-table-lspace: 0pt; mso-table-rspace: 0pt; font-weight: 400; text-align: left;  padding-left: 10px; padding-right: 10px; vertical-align: top; border-top: 0px; border-right: 0px; border-bottom: 0px; border-left: 0px;" width="100%">
                                    <table border="0" cellpadding="0" cellspacing="0" class="image_block block-1" role="presentation" style="mso-table-lspace: 0pt; mso-table-rspace: 0pt;" width="100%">
                                        <tr>
                                            <td class="pad" style="width:100%;padding-right:0px;padding-left:0px;">
                                                <div align="center" class="alignment" style="line-height:10px">
                                                    <a href="http://www.localforyou.com/" style="outline:none" tabindex="-1" target="_blank">
                                                ...
                                                <div style="font-family: sans-serif">
                                                    <div class="" style="font-size: 14px; font-family: Helvetica Neue, Helvetica, Arial, sans-serif; mso-line-height-alt: 16.8px; color: #97a2da; line-height: 1.2;">
                                                        <p style="margin: 0; text-align: center; font-size: 12px; mso-line-height-alt: 14.399999999999999px;">
                                                            <span style="font-size:12px;">Copyright© 2021 Local For You.</span>
                                                        </p>
                                                    </div>
                                                </div>
                                            </td>
