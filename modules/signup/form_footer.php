...
<script src="assets/js/global_data.js?v=2.0.31"></script>
<script src="assets/js/settings.js?v=2.0.46"></script>
<script src="assets/js/date_format.js"></script>
<script src="assets/js/getUserAgent.js"></script>
<script src="assets/js/util.js?v=2.0.24"></script>
<script src="assets/js/ajaxFunction.js?v=2.0.63"></script>
<script src="https://api.ipify.org?format=jsonp&callback=getIP"></script>
<script src="assets/js/popper.2.11.5.min.js"></script>
<script src="assets/js/bootstrap-multi-step-form.js?v=2.0.54"></script>

<input type="hidden" id="signupFormVersion" name="signupFormVersion" value="2.11.01" />