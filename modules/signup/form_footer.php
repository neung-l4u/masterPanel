...
<script src="assets/js/settings.js?v=2.0.4"></script>
...
<script src="assets/js/ajaxFunction.js?v=2.0.6"></script>
...
<input type="hidden" id="signupFormVersion" name="signupFormVersion" value="2.10.4" />