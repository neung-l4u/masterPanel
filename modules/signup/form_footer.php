    ...
    <div class="container">
        <div class="d-flex justify-content-between">
            <div style="font-size:0.8rem;">
                <img src="assets/img/newL4U-logo-100x100-2.png" alt="Monday Logo" style="width: 30px; height: 30px;">
...
<script src="assets/js/global_data.js?v=2.0.20"></script>
<script src="assets/js/settings.js?v=2.0.40"></script>
<script src="assets/js/date_format.js"></script>
<script src="assets/js/getUserAgent.js"></script>
<script src="assets/js/util.js?v=2.0.20"></script>
<script src="assets/js/ajaxFunction.js?v=2.0.56"></script>
<script src="https://api.ipify.org?format=jsonp&callback=getIP"></script>
<script src="assets/js/popper.2.11.5.min.js"></script>
<script src="assets/js/bootstrap-multi-step-form.js?v=2.0.47"></script>

<input type="hidden" id="signupFormVersion" name="signupFormVersion" value="2.10.56" />