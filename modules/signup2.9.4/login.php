...
<head>
    ...
    <title>L4U Online Ordering System</title>
                                ...
                                <div class="card-body p-4 p-lg-5 text-black">
                                    <form>
                                        <div class="d-flex align-items-center mb-3 pb-1">
                                            ...
                                            <span class="h2 fw-light mb-0">Local For You</span>
                                        </div>
                                        ...
                                        <div class="pt-1 mb-4">
                                            <button class="btn btn-primary btn-lg btn-block" type="button" id="cmdLogin">
...
<footer class="credit">Author: Neung - Distributed By: <a title="Awesome Online Shopping Cart Application"
                                                          href="https://www.localforyou.com" target="_blank">Local For
        You</a></footer>
