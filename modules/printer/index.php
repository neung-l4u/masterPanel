...
<body>
    <div class="container">
        <div class="row mt-5">
            <div class="col">
                <h3>ORDER TAKING APP PRINTER SOLUTIONS</h3>
                <h5 class="mt-3">Connecting To A Thermal Printer – What Are My Options</h5>
                <ol class="mt-3">
                    <li class="mb-2"><strong>Bring your own Printer</strong> <br>if it is connected to your network and your device receiving the order is connected to the network, you might be in luck and the device will find your printer and print. <br><small>(Note we do not provide technical support for this option)</small></li>
                    <li><strong>You can purchase One: Recommended</strong> <br> The two options we provide are designed for a simple “Plug n Play” connection with limited knowledge to implement</li>
                </ol>
            </div>
        </div><!--row-->
        ...
        <div class="card mt-4">
            <div class="card-body">
                ...
                <div class="form-check">
                    <input class="form-check-input country" type="radio" name="country" id="Australia" value="AU" checked>
                    <label class="form-check-label" for="Australia">
                        Australia
                    </label>
                </div>
                <div class="form-check">
                    <input class="form-check-input country" type="radio" name="country" value="NZ" id="NewZealand">
                    <label class="form-check-label" for="NewZealand">
                        New Zealand
                    </label>
                </div>
            </div>
        ...
        <div class="card mt-3 mb-5">
            <div class="card-body">
                ...
                <div class="mb-3">
                    <div class="form-floating">
                        <input type="text" class="form-control" id="inputShopName" maxlength="200" placeholder="Shop name" autocomplete="off">
                        <label id="labelShopName" for="inputShopName" class="form-label formLabel">Shop name</label>
                    </div>
                </div>
                <div class="mb-3">
                    <div class="form-floating">
                        <textarea class="form-control" id="inputAddress" placeholder="Address" style="height: 100px"></textarea>
                        <label id="labelAddress" for="inputAddress" class="form-label formLabel">Shipping address here</label>
                    </div>
                </div>
                <div class="d-flex justify-content-center">
                    <p class="text-danger">
                        <small>
                            Note: No payment is taken here, you will receive an email with an invoice for your Printer from the Supplier directly
                        </small>
                    </p>
                </div>
                <div class="d-flex justify-content-end">
                    <button type="button" class="btn btn-primary btn-lg" id="btnSubmit" onclick="cmdSubmit();">Order Now</button>
                </div>
            </div>
        </div>

        <?php include("modalRespondEmail.php"); ?>

    </div><!--container-->

    <script src="https://cdn.jsdelivr.net/npm/bootstrap@5.0.2/dist/js/bootstrap.bundle.min.js" integrity="sha384-MrcW6ZMFYlzcLA8Nl+NtUVF0sA7MsXsP1UyJoMp4YLEuNSfAP+JcXn/tWtIaxVXM" crossorigin="anonymous"></script>
    <script src="https://cdnjs.cloudflare.com/ajax/libs/jquery/3.6.0/jquery.min.js"></script>
    <script src="assets/js/printerAction.js"></script>
</body>
</html>