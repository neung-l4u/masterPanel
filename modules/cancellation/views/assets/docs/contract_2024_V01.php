...
<div class="container-fluid py-5 px-5">
    ...
    <section>
        <div class="mt-5 break">
                ...
                <p class="mb-4">1.1 The term of this Agreement shall span an agreed minimum of <?php echo $data["contractPeriod"]; ?> 
                months. The client understands that the contract will continue past the end date by month to month at the same agreed price. 
                The Agreement for subsequent terms of 0,3 or 12 months can be agreed upon by mutual concurrence and the advertised price will 
                be charged unless otherwise agreed to.
                </p>

                <h5 class="mb-2">2. Services</h5>
                <p class="mb-4">2.1 The Service Provider undertakes to furnish marketing services to the client throughout the duration of 
                    this Agreement. The specifics of the marketing services and strategies will be determined through mutual agreement and 
                    may evolve over time. However, the client is obligated to consistently engage in some form of marketing services provided by the Service Provider.
                </p>
                ...
                <ol type="A">
                    ...
                    <li>For clients on a 12-month plan, the Client can pause the marketing plan for a maximum of 2 months. The pauses can be taken for any 2 non-consecutive months within the term of this Agreement.</li>
                    <li>The length of the Agreement will be extended by the number of months paused. The new end date will be determined based on the total term of the Agreement plus any months paused.</li>
                </ol>
                ...
                <p class="mb-4">3.1 The client commits to remit monthly payments to the Service Provider for the entire term of this Agreement. 
                    ...
                    date agreed upon by both parties. Payments made more than 10 days in arrears will attract late fees equal to 10% of the monthly
                     payment. In the event of non-payment, the Service Provider reserves the right to refer the outstanding amount to a credit collector 
                     or third-party agency for collection. The client shall bear any costs or fees associated with engaging a credit collector.
                </p>

                <h5 class="mb-2">4. Termination</h5>
                <p class="mb-4">4.1 Either party may terminate this Agreement if it is proven that the promised services
                    were not achieved, written notice is required to the other party for consideration of early termination.
                </p>
            <br>
        ...
        <br><br>
        <div class="mt-5">
            <p class="mb-4">4.2 If the client terminates the Agreement before the contract maturity date, the Client
                is obligated to pay the Service Provider the remaining contract value, including any applicable late
                fees.
            </p>

            <h5 class="mb-2">5. Obligations</h5>
            <p class="mb-4">5.1 The Service Provider pledges to deliver marketing services in a punctual and professional manner, 
                ensuring compliance with minimum industry standards. Failure to do so may result in the termination of this Agreement.
                  See services provided in Schedule 1.
            </p>
            <h5 class="mb-2">6. Confidentiality</h5>
            <p class="mb-4">6.1 Both Parties commit to keeping any confidential information disclosed during the course of this Agreement confidential and not disclosing it to any third party without prior written consent.
            </p>

            <h5 class="mb-2">7. Governing Law and Jurisdiction</h5>
            <p class="mb-4">7.1 This Agreement shall be governed by and construed in accordance with the laws of Australia. Any disputes arising out of or in connection with this Agreement shall be 
                ...
                <div>
                    ...
                    <table class="table">
                        ...
                        <tr>
                            ...
                            <td>
                            Attract local customers and enhance brand reliability through local advertising.  Send our local promotions
                            </td>
                            <td>
