...
$countryText = !empty($data['countryText']) ? $data['countryText'] : '-';
$shopName = !empty($data['shopName']) ? $data['shopName'] : '-';
$tradingName = !empty($data['tradingName']) ? $data['tradingName'] : '-';
$address = !empty($data['address']) ? $data['address'] : '-';
$fullName = !empty($data['fullName']) ? $data['fullName'] : '-';
$mobile = !empty($data['mobile']) ? $data['mobile'] : '-';
$email = !empty($data['email']) ? $data['email'] : '-';
$reason = !empty($data['reason']) ? $data['reason'] : '-';
$lastDate = !empty($data['lastDate']) ? $data['lastDate'] : '-';
$comment = !empty($data['comment']) ? $data['comment'] : '-';
?>

<?php
$mail_from = $countryText.' Customer <'.$email.'>';
$mail_to = 'iamatomix@gmail.com';
$mail_cc = 'Me <neung@localforyou.com>';
$mail_bcc = 'sorasak.tns@gmail.com';
$mail_reply = 'admin@localforyou.com';

$subject = $country." Customer send a cancellation request - ".$shopName;
															...
															<td class="pad">
																<div style="font-family: sans-serif">
																	<div class="" style="font-size: 14px; font-family: Helvetica Neue, Helvetica, Arial, sans-serif; mso-line-height-alt: 16.8px; color: #506bec; line-height: 1.2;">
																		<p style="margin: 0; font-size: 14px; mso-line-height-alt: 16.8px;"><strong><span style="font-size:38px;"><span style="font-size:20px;">'.$shopName.'</span></span></strong></p>
																	</div>
																</div>
															</td>
														</tr>
														...
														<tr>
															<td class="pad">
																<div style="color:#000000;font-size:14px;font-family:Helvetica Neue, Helvetica, Arial, sans-serif;font-weight:400;line-height:120%;text-align:left;direction:ltr;letter-spacing:0px;mso-line-height-alt:16.8px;">
																	<p style="margin: 0; margin-bottom: 16px;"><strong>Country :</strong> '.$countryText.'<br>
																	<strong>Shop name :</strong> '.$shopName.'<br>
																	<strong>Trading name :</strong> '.$tradingName.'<br>
																	<strong>Address :</strong><br>
																	'.$address.'</p>
																	<p style="margin: 0; margin-bottom: 16px;"><strong>Full name :</strong> '.$fullName.'<br>
																	<strong>Mobile :</strong> '.$mobile.'<br>
																	<strong>Email :</strong> <a href="'.$email.'" style="text-decoration: underline; color: #0068a5;">'.$email.'</a></p>
																	<p style="margin: 0; margin-bottom: 16px;"><strong>Last date : '.$lastDate.'<br>
																	Reason :</strong> '.$reason.'</p>
														...
														<tr>
															<td class="pad" style="width:100%;padding-right:0px;padding-left:0px;">
																<div align="center" class="alignment" style="line-height:10px">
																	<a href="https://www.localforyou.com/" style="outline:none" tabindex="-1" target="_blank"><img alt="Logo" src="https://signup.localforyou.com/assets/img/newL4U-logo-100x100.png" style="display: block; height: auto; border: 0; width: 100px; max-width: 100%;" title="Your Logo" width="100"></a>
																</div>
															</td>
														</tr>
													</table>
