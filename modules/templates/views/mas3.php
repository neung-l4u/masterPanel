...
<head>
    ...
    <title>Template submission : Massage 3</title>
</head>
<!-- Google tag (gtag.js) -->
        ...
        <div class="col">
            ...
            <nav>
                <div class="nav nav-tabs page-tabs" id="nav-tab" role="tablist">
                    ...
                    <button class="nav-item nav-link" id="tab-res1Services" data-bs-toggle="tab" data-bs-target="#res1Services" type="button" role="tab" aria-selected="false">Serviecs</button>
