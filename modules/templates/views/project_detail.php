        ...
        <div class="col-7">
            ...
            <div class="row mb-3">
                <div class="col">
                    ...
                    <div id="openingBox">
                        <textarea class="form-control" id="openingText" rows="3"></textarea>
                    </div>
                    <div id="openingForm">
            ...
            <div class="row">
                <div class="col">
                    ...
                    <div id="pickupAndDelivery">
                        <div id="deliveryBox">
                            <textarea class="form-control" id="deliveryText" rows="3"></textarea>
                        </div>
                        <div id="deliveryForm">
                            <form id="deli-form" class="border rounded px-4 py-3">
                                <div class="mb-3 px-3">
                                    <div class="days-list">
