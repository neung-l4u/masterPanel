        ...
        <div class="col-6">
            <nav>
                <div class="nav nav-tabs page-tabs" id="nav-tab" role="tablist">
                    <button class="nav-item nav-link active" id="nav-mas1Home" data-bs-toggle="tab" data-bs-target="#mas1Home" type="button" role="tab" aria-selected="true" onclick="selectPage('tab-mas1Home');">Home</button>
