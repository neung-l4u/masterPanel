            ...
            <div class="card-body">
                <div class="row">
                    ...
                    <div class="col d-flex align-items-center justify-content-end gap-3">
                        ...
                        <button type="button" class="btn advancedReport" data-bs-toggle="modal" data-bs-target="#advancedReportModal">Advanced Report</button>
                    </div>
        ...
        <div class="modal-content">
            <div class="modal-header bg-primary text-white">
                <h5 class="modal-title" id="advancedReportModalLabel">
                    <svg xmlns="http://www.w3.org/2000/svg" width="18" height="18" fill="currentColor" class="bi bi-file-earmark-text me-2" viewBox="0 0 16 16"><path d="M5.5 7a.5.5 0 0 0 0 1h5a.5.5 0 0 0 0-1h-5zM5 9.5a.5.5 0 0 1 .5-.5h5a.5.5 0 0 1 0 1h-5a.5.5 0 0 1-.5-.5zm0 2a.5.5 0 0 1 .5-.5h2a.5.5 0 0 1 0 1h-2a.5.5 0 0 1-.5-.5z"/><path d="M9.5 0H4a2 2 0 0 0-2 2v12a2 2 0 0 0 2 2h8a2 2 0 0 0 2-2V4.5L9.5 0zm0 1v2A1.5 1.5 0 0 0 11 4.5h2V14a1 1 0 0 1-1 1H4a1 1 0 0 1-1-1V2a1 1 0 0 1 1-1h5.5z"/></svg>
                    Advanced Report
                </h5>
            ...
            <form id="advancedReportForm" enctype="multipart/form-data">
                <div class="modal-body">
                    ...
                    <div class="mb-3">
                        <label for="advBoard" class="form-label fw-bold">Board <span class="text-danger">*</span></label>
                        <input type="text" class="form-control" id="advBoard" name="board" placeholder="e.g. Projects | TH, CRM" required>
                    </div>

                    <div class="mb-3">
                        <label for="advSubject" class="form-label fw-bold">Subject <span class="text-danger">*</span></label>
                    ...
                    <div class="mb-3">
                        <label for="advDetail" class="form-label fw-bold">Detail</label>
                        <textarea class="form-control" id="advDetail" name="detail" rows="4" placeholder="Describe the issue in detail..."></textarea>
                    </div>

                    <div class="mb-3">
                        <label for="advAttachment" class="form-label fw-bold">Attach file <small class="text-muted">(picture only, optional)</small></label>
                        <input type="file" class="form-control" id="advAttachment" name="attachment" accept="image/*">
                        <div class="form-text">Supported: JPG, PNG, GIF, WEBP (max 5MB)</div>
                    </div>

                    <hr>

                    <div class="mb-3">
                        <label for="advScreenInternet" class="form-label fw-bold">
                            Screenshot Internet Speed Test <span class="text-danger">*</span>
                        </label>
                        <div class="alert alert-info py-2 mb-2" style="font-size: 13px;">
                            <svg xmlns="http://www.w3.org/2000/svg" width="14" height="14" fill="currentColor" class="bi bi-info-circle me-1" viewBox="0 0 16 16"><path d="M8 15A7 7 0 1 1 8 1a7 7 0 0 1 0 14zm0 1A8 8 0 1 0 8 0a8 8 0 0 0 0 16z"/><path d="m8.93 6.588-2.29.287-.082.38.45.083c.294.07.352.176.288.469l-.738 3.468c-.194.897.105 1.319.808 1.319.545 0 1.178-.252 1.465-.598l.088-.416c-.2.176-.492.246-.686.246-.275 0-.375-.193-.304-.533L8.93 6.588zM9 4.5a1 1 0 1 1-2 0 1 1 0 0 1 2 0z"/></svg>
                            Please run a speed test at
                            <a href="https://fiber.google.com/speedtest/" target="_blank" class="fw-bold">fiber.google.com/speedtest</a>
                    ...
                    <div class="mb-3">
                        <label for="advScreenComputer" class="form-label fw-bold">
                            Screenshot My Computer Info <span class="text-danger">*</span>
                        </label>
                        <div class="alert alert-warning py-2 mb-2" style="font-size: 13px;">
                            <svg xmlns="http://www.w3.org/2000/svg" width="14" height="14" fill="currentColor" class="bi bi-laptop me-1" viewBox="0 0 16 16"><path d="M13.5 3a.5.5 0 0 1 .5.5V11H2V3.5a.5.5 0 0 1 .5-.5h11zm-11-1A1.5 1.5 0 0 0 1 3.5V12h14V3.5A1.5 1.5 0 0 0 13.5 2h-11zM0 12.5h16a1.5 1.5 0 0 1-1.5 1.5h-13A1.5 1.5 0 0 1 0 12.5z"/></svg>
